...
import static com.github.hexagonoframework.example.application.command.UpdateBookmark.ErrorCode.BOOKMARK_DOES_NOT_EXIST;
import static com.github.hexagonoframework.example.application.command.UpdateBookmark.ErrorCode.BOOKMARK_NAME_ALREADY_EXISTS;
import static com.github.hexagonoframework.example.application.command.UpdateBookmark.ErrorCode.BOOKMARK_URL_ALREADY_EXISTS;
import static com.github.hexagonoframework.example.application.command.UpdateBookmark.ErrorCode.INVALID_BOOKMARK_DESCRIPTION;
import static com.github.hexagonoframework.example.application.command.UpdateBookmark.ErrorCode.INVALID_BOOKMARK_ID;
import static com.github.hexagonoframework.example.application.command.UpdateBookmark.ErrorCode.INVALID_BOOKMARK_NAME;
import static com.github.hexagonoframework.example.application.command.UpdateBookmark.ErrorCode.INVALID_BOOKMARK_URL;
...
import com.github.hexagonoframework.example.domain.bookmark.BookmarkChangeService;
